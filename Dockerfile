...
RUN apt-get -y update && apt-get install -y \
    ...
    && toolset="$(curl -sL https://raw.githubusercontent.com/actions/runner-images/main/images/ubuntu/toolsets/toolset-2404.json)" \
...
# Install LTS Node.js via NodeSource
RUN curl -fsSL https://deb.nodesource.com/setup_lts.x | bash - \
    && apt-get install -y nodejs \
    && npm install -g grunt gulp n parcel-bundler typescript newman webpack webpack-cli
